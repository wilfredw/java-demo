...
public class ProxyPerformanceTest {
    ...
    public static void main(String[] args) {
        System.setProperty(DebuggingClassWriter.DEBUG_LOCATION_PROPERTY, ".\\");  //--该设置用于输出cglib动态代理产生的类
        ...
        Test dynamicProxy = JdkProxyTest.newProxyInstance(nativeTest);
        Test cglibProxy = CglibProxyTest.newProxyInstance(TestImpl.class);
        Test cglibInterfaceProxy = CglibInterfaceProxyTest.newProxyInstance(nativeTest, Test.class);
        ...
        runWithoutMonitor(cglibInterfaceProxy, preRunCount);
        ...
        tests.put("CglibInf ", cglibInterfaceProxy);
        int repeatCount = 3;
